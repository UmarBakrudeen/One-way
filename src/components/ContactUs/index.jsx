                        ...
                        <div className="col-lg-5 mb-2">
                            ...
                            >
                                <div className="d-flex mb-3">
                                    <i
                                        className="fa fa-2x fa-map-marker-alt text-primary flex-shrink-0 mr-3"
                                    ></i>
                                    <div className="mt-n1">
                                        <h5 className="text-light">Head Office</h5>
                                        <p>Tiruchirapalli, TamilNadu , India</p>
                                    </div>
                                </div>
                                <div className="d-flex mb-3">
                                    <i
                                ...
                                <div className="d-flex mb-3">
                                    <i
                                        className="fa fa-2x fa-envelope-open text-primary flex-shrink-0 mr-3"
                                    ></i>
                                    <div className="mt-n1">
                                        <h5 className="text-light">Customer Service</h5>
                                        <p>onewaytaxt@gmail.com</p>
                                    </div>
                                </div>
                                <div className="d-flex">
                                    ...
                                    ></i>
                                    <div className="mt-n1">
                                        <h5 className="text-light">INQUIRIES & QUESTIONS</h5>
                                        <p className="m-0">onewaytaxt@gmail.com</p>
                                    </div>
                                </div>
                            </div>
                        </div>
